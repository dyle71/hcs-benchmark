 ...
 * @return  A value, representing the version.
 */
inline std::uint32_t GetHCSBenchmarkVersion_1_0_1() {
 ...
 * @return  A value, representing the version.
 */
inline std::uint32_t GetHCSBenchmarkVersion_1_0_2() {
...
inline std::uint32_t GetCurrentVersion() {
    return GetHCSBenchmarkVersion_1_0_2();
}
